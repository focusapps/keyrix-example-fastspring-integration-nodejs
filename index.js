...
//    and then create a Keyrix license resource. After that has successfully been done,
//    we'll render a 'success' page containing our user's license key which they can
//    use inside of our software product, e.g.:
//
//    curl -X POST https://keyrix-api.focusapps.app/v1/accounts/$KEYRIX_ACCOUNT_ID/licenses/actions/validate-key \
//      -H 'Content-Type: application/vnd.api+json' \
//      -H 'Accept: application/vnd.api+json' \
//      -d '{
//            "meta": {
//              "key": "$KEYRIX_LICENSE_KEY"
//            }
//          }'
app.get('/success', async (req, res) => {
  ...
  // 3. Create a user-less Keyrix license for our new FastSpring customer.
  const kreq = await fetch(`https://keyrix-api.focusapps.app/v1/accounts/${KEYRIX_ACCOUNT_ID}/licenses`, {
    method: 'POST',
    headers: {
